...
import co.za.bryanallott.radiomobile.bb.lib.HttpConnectionFactory;
import co.za.bryanallott.radiomobile.bb.lib.NoMoreTransportsException;
...
public class StreamingPlayer implements PlayerListener{
	 ...
	 * @throws IOException, NoMoreTransportsException 
	 */
	private void initConnection() throws IOException, NoMoreTransportsException {
		try{
			log(0, "Calling SP.initConnection()..");
			synchronized(connectionLock){
				
				HttpConnectionFactory factory = new HttpConnectionFactory(getLocator());
